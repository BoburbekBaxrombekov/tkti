                    ...
                    {media.map(item => (
                        <li key={item.id} className="media_item">
                            <div className="media_img">
                                <img src={`http://localhost:3001/getfiles/${item.path}`} alt="" width={300} height={200}/>
                            </div>
                            <div className="media_body mt-3">
                                <p><a href={`http://localhost:3001/getfiles/${item.path}`}>{`http://localhost:3001/getfiles/${item.path}`}</a>  </p>
